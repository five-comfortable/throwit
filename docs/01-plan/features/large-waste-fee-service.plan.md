...
| Front-end | 최가을, 최은아, 강해원 | UI 개발, API 연동, 상태 관리 |
...
### Phase 5: Frontend 개발 (담당: 최가을, 최은아, 강해원)
...
5. UI 컴포넌트 디자인
6. 전체 페이지 목업 제작
7. 페이지 개발 (5개: 온라인 배출 안내, 마이페이지, 영수증, 재활용 목록, 재활용 등록)
...
4. TypeScript 타입 정의
5. 핵심 페이지 개발 (6개: 홈, 수수료, 배출 신청, 검토, 결제, 완료)
6. 라우팅 설정
...
[Step 5] 페이지 개발 (Backend API + 공통 컴포넌트 완료 후)
  ├── ⬜ 최가을: 홈, 수수료 조회, 배출 신청 플로우 (6페이지)
  ├── ⬜ 최은아: 인증, 오프라인 안내 (6페이지)
  └── ⬜ 강해원: 온라인 안내, 마이페이지, 재활용 (5페이지)
         │
[Step 6] 연동 및 통합 (전원)
